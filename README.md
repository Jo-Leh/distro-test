![docker image](https://github.com/Jo-Leh/distro-test/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Jo-Leh/distro-test.git
    cd distro-test
    ```
    ...
    ```sh
    curl-L -o distro-test.zip "https://github.com/Jo-Leh/distro-test/archive/main.zip"
    unzip distro-test.zip
    cd distro-test
    ```
...
your `docker-compose.yaml` with `ghcr.io/jo-leh/distro-test:main` for the services
...
```sh
docker pull ghcr.io/jo-leh/distro-test/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Jo-Leh/distro-test/manifests/main": unauthorized`
